...
SELECT * FROM Examples.TestChild;
...
BEGIN TRANSACTION;
    INSERT INTO Examples.TestParent(ParentId, ParentName)
    VALUES (4, 'Linda'); -- success

    DELETE Examples.TestParent
    WHERE ParentName = 'Bob'; -- fail?
COMMIT TRANSACTION;
...
SELECT * FROM Examples.IsolationLevels;
...
BEGIN TRANSACTION;
    ...
    WAITFOR DELAY '00:00:15'; -- Session 2 updates table
...
BEGIN TRANSACTION;
    SELECT RowId, ColumnText
    FROM Examples.IsolationLevels;
    WAITFOR DELAY '00:00:15'; -- INSERT in Session 2
    SELECT RowId, ColumnText
    FROM Examples.IsolationLevels; -- Phantom Read
ROLLBACK TRANSACTION;
...
BEGIN TRANSACTION;
    ...
    WAITFOR DELAY '00:00:15'; -- Tried to INSERT
...
BEGIN TRANSACTION;
    ...
    WAITFOR DELAY '00:00:15'; -- INSERT row 7
